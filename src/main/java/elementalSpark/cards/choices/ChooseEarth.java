...
public class ChooseEarth extends AbstractDynamicCard {

    // TEXT DECLARATION

    public static final String ID = ElementalSpark.makeID(ChooseEarth.class.getSimpleName());
    public static final String IMG = makeCardPath("ChooseEarth.png");
    ...
    public void onChoseThisOption() {
        addToBot(new ChangeElementalStanceAction(ElementType.Earth));
    }
